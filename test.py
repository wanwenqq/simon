...
@LastEditTime : 2020-01-11 22:43:19
@LastEditors  : Anders
...
def do_request():
    ...
    while True:
        ...
        req_url = 'http://www.overfly.xin/h5-ft/ft/sms/code'
        mbs = {'16620933652',}
        body = {'mobile':'16571956545'}
        try:
            requests.adapters.DEFAULT_RETRIES = 5 # 增加重连次数
            s = requests.session()
            s.keep_alive = False # 关闭多余连接
            response = s.post(req_url, data=json.dumps(body),headers = ad_header,proxies=proxies,timeout=10)
